...
const recipes = [
    ...
    },
    {
        ...
        instructionsList: [
                'Remove the casings from sausage links and cut into small pieces',
                'Add sausage, ground beef, 1 egg, breadcrumbs, parmesean cheese, heavy cream, salt, pepper, garlic powder and parsley to a large mixing bowl.',
                'Mix thoroughly until well combined.',
                'Shape mixture into individual meatballs and place on baking tray.',
                'Place baking tray into fridge to set for at least 20 mins.',
                'While meatballs are setting, add half an onion (diced) and italian seasoning into a large pot with olive oil over med heat.',
                'Once onions are soft, add minced garlic.',
                'Add 1 can (29oz) of tomato sauce to pot and stir. Bring sauce to a simmer.',
                'Add meatballs to sauce, turn down heat, and cover. Cook for 60 mins, stirring every 15 mins.',
                'Cook for an additional 15 mins uncovered to reduce sauce if necessary.',
            ],
        prepTime: '30',
        cookTime: '75',
        time: 105,
